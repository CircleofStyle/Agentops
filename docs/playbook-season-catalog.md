...
| 6 | `new-lead-welcome-sequence` | Instant welcome + intake for new inquiries | Sofortige Begrüßung und Aufnahme bei neuen Anfragen | Capture | Zapier | planned | ✅ | New leads get an immediate welcome and a short intake form — before they shop elsewhere. | Zapier *(pending)* |
| 7 | `job-completion-checklist` | Auto-send completion summary + upsell prompt | Abschlusszusammenfassung und Upsell automatisch senden | Deliver | Zapier | planned | ✅ | Job done → client gets a summary, checklist, and a natural upsell ask. | Zapier *(pending)* |
| 8 | `referral-ask-workflow` | Ask happy clients for referrals on schedule | Zufriedene Kunden planmässig um Empfehlungen bitten | Grow | Zapier | planned | ✅ | Satisfied clients get a timed referral ask — word-of-mouth on autopilot. | Zapier *(pending)* |
...
| 11 | `review-response-templates` | Draft replies to Google reviews in one click | Google-Bewertungen mit einem Klick beantworten | Reputation | Zapier | planned | ✅ | New reviews get a draft reply you can send in one click — reputation stays warm. | Zapier *(pending)* |
